...
// CreateTblCrawlEvents 创建爬虫大事迹
// @Tags TblCrawlEvents
// @Summary 创建爬虫大事迹
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body pkgCrawlReports.TblCrawlEvents true "创建爬虫大事迹"
...
// DeleteTblCrawlEvents 删除爬虫大事迹
// @Tags TblCrawlEvents
// @Summary 删除爬虫大事迹
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body pkgCrawlReports.TblCrawlEvents true "删除爬虫大事迹"
...
// DeleteTblCrawlEventsByIds 批量删除爬虫大事迹
// @Tags TblCrawlEvents
// @Summary 批量删除爬虫大事迹
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateTblCrawlEvents 更新爬虫大事迹
// @Tags TblCrawlEvents
// @Summary 更新爬虫大事迹
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body pkgCrawlReports.TblCrawlEvents true "更新爬虫大事迹"
...
// FindTblCrawlEvents 用id查询爬虫大事迹
// @Tags TblCrawlEvents
// @Summary 用id查询爬虫大事迹
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query pkgCrawlReports.TblCrawlEvents true "用id查询爬虫大事迹"
...
// GetTblCrawlEventsList 分页获取爬虫大事迹列表
// @Tags TblCrawlEvents
// @Summary 分页获取爬虫大事迹列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query pkgCrawlReportsReq.TblCrawlEventsSearch true "分页获取爬虫大事迹列表"
