// 自动生成模板TblKolResource
package pkgCrawlReports

// tblKolResource表 结构体  TblKolResource
type TblKolResource struct {
	...
	Platform          *bool  `json:"platform" form:"platform" gorm:"column:platform;comment:平台：1 - TikTok 2 - YouTube 3 - Instagram;"`      //平台：1 - TikTok 2 - YouTube 3 - Instagram
...
// TableName tblKolResource表 TblKolResource自定义表名 tbl_kol_resource
func (TblKolResource) TableName() string {
	return "tbl_kol_resource"
}
