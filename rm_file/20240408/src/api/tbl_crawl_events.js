...
// @Param data body model.TblCrawlEvents true "创建时间表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.TblCrawlEvents true "删除时间表"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除时间表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /e/deleteTblCrawlEvents [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.TblCrawlEvents true "更新时间表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.TblCrawlEvents true "用id查询时间表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取时间表列表"
